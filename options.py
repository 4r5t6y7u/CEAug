...
file_dir = '/workspace/arketi/proj/monodepth2-master/'
...
parser.add_argument("--data_path_pre_test",
                    type=str,
                    help="path for test data, specify when training on Cityscapes.")
parser.add_argument("--log_dir",
                    type=str,
                    help="log directory",
                    # default=os.path.join(os.path.expanduser("~"), "tmp"))
                    default=os.path.join(os.path.expanduser("~"), "/workspace/arketi/proj/monodepth2-master/bde/tmp"))
...
parser.add_argument("--frame_ids",
                    ...
                    help="frames to load",
                    default=[0, -1, 1])
parser.add_argument("--local_crop",
                    help="if set, use the local crop resize augument)",
                    action="store_true")
parser.add_argument("--patch_reshuffle",
                    help="if set, use the patch reshuffle augument)",
                    action="store_true")
parser.add_argument("--CEAug",
                    help="if set, use the crop and wide augument)",
                    action="store_true")
parser.add_argument("--dc_coefficient",
                    type=float,
                    help="dc loss coefficient",
                    default=0.07)
